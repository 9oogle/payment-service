...
public class PaymentEventDto {
  ...
  public record Created(UUID orderId, LocalDateTime createdAt) {}

  public record CreateFailed(UUID orderId, LocalDateTime failedAt, LocalDateTime failReason) {}

  public record Approved(
      // 승인 완료
      UUID orderId, String paymentKey, long amount, LocalDateTime approvedAt) {}

  // 승인 실패
  @Builder
  public record ApprovalFailed(
      UUID orderId, long amount, LocalDateTime failedAt, String failReason) {
  ...
  public record Canceled(
      UUID orderId, long amount, LocalDateTime canceledAt, String cancelReason) {}

  // 결제 취소 실패
  @Builder
  public record CancelFailed(UUID orderId, long amount, LocalDateTime failedAt, String failReason) {
